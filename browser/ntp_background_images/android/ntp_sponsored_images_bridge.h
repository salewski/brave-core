...
#ifndef BRAVE_BROWSER_NTP_BACKGROUND_IMAGES_ANDROID_NTP_SPONSORED_IMAGES_BRIDGE_H_
#define BRAVE_BROWSER_NTP_BACKGROUND_IMAGES_ANDROID_NTP_SPONSORED_IMAGES_BRIDGE_H_
...
class NTPSponsoredImagesBridge : public NTPBackgroundImagesService::Observer,
                                 public KeyedService {
 public:
...
#endif  // BRAVE_BROWSER_NTP_BACKGROUND_IMAGES_ANDROID_NTP_SPONSORED_IMAGES_BRIDGE_H_
