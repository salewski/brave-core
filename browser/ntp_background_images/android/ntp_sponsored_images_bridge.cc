...
#include "brave/browser/ntp_background_images/android/ntp_sponsored_images_bridge.h"
...
JNI_NTPSponsoredImagesBridge_GetInstance(JNIEnv* env,
  ...
  return ntp_background_images::NTPSponsoredImagesBridgeFactory::GetInstance()
...
void NTPSponsoredImagesBridge::OnUpdated(NTPBackgroundImagesData* data) {
  JNIEnv* env = AttachCurrentThread();
