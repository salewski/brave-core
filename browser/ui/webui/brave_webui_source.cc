  ...
  static std::map<std::string, std::vector<WebUISimpleItem> > resources = {
    {
      std::string("newtab"), {
        ...
        { "ntp-dummy-brandedwallpaper/brave.png",
            IDR_BRAVE_NEW_TAB_DUMMY_BRANDED_WALLPAPER_BRAVE_ICON },
        { "ntp-dummy-brandedwallpaper/bat.png",
            IDR_BRAVE_NEW_TAB_DUMMY_BRANDED_WALLPAPER_BAT_ICON },
