...
const localeData = {
  strings: {
    ...
    addFundsTermsOfSale: 'By clicking Add Funds & Purchase, you agree to $1Brave’s Terms of Sale$2.',
    cardNumber: 'Card number',
    expiration: 'Expiration',
    securityCode: 'Security code',
    saveThisCard: 'Save this card',
    batCheckout: 'BAT Checkout',
    goBack: 'Go Back',
    ...
    confirmTermsOfSale: 'By clicking Confirm, you agree to $1Brave’s Terms of Sale$2.',
    ...
    payWithBatTermsOfSale: 'By clicking Pay with BAT, you agree to $1Brave’s Terms of Sale$2.',
  ...
  .add('Add Funds', () => {
    ...
    return (
      <LocaleContext.Provider value={localeData}>
        <DialogFrame showBackground={true} showTitle={true} onClose={onDialogClose}>
          <AddFundsPanel
            amountNeeded={knobs.number('amountNeeded', 30)}
            walletBalance={knobs.number('walletBalance', 15)}
