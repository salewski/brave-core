...
void AdsServiceImpl::OnGetCreativePublisherAdsToPreCache(
    const ads::OnGetCreativePublisherAdsToPreCacheCallback& callback,
    const ads::CreativePublisherAdList& ads) {
  if (!connected()) {
    return;
  }
...
void AdsServiceImpl::OnFlagPublisherAdWasPreCached(
    const ads::OnFlagPublisherAdWasPreCachedCallback& callback,
    const std::string& creative_instance_id,
...
void AdsServiceImpl::GetCreativePublisherAdsToPreCache(
    ads::OnGetCreativePublisherAdsToPreCacheCallback callback) {
  base::PostTaskAndReplyWithResult(file_task_runner_.get(), FROM_HERE,
...
void AdsServiceImpl::FlagPublisherAdWasPreCached(
    const std::string& creative_instance_id,
    ads::OnFlagPublisherAdWasPreCachedCallback callback) {
  base::PostTaskAndReplyWithResult(file_task_runner_.get(), FROM_HERE,
